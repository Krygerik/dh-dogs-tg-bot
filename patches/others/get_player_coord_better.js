...
var SetIsSpiritWalking = new NativeFunction(
  base.add(0xEC7690),
  'void',
  ['pointer', 'bool', 'float'], // (this*, bNewIsSpiritWalking, Duration)
  'win64'
);
...
function GetMessageByThingValues(PlayerStateArray) {
    for (var i = 0; i < PlayerStateArray.length; i++) {
		...
		SendMessage("Calling Spirit Walk");
		//SetIsSpiritWalking(HumanCharacter, true, 15.0);
