 ...
 * - Logs the coordinates of all actors once every 5 seconds.
 * 
 * Requirements:
 * - Frida installed on your system.
 * - Appropriate permissions to write to the specified log file path.
 * - Accurate base address and relative offsets for your game version.
 * 
 * Usage:
 * - Replace "/path/to/your/log/ActorLocation.log" with your desired log file path.
 * - Ensure the base address and relative offsets are correct.
 * - Run the script using Frida with the target process.
 */
...
const LOG_FILE_PATH = "TheActorLocation.log"; // e.g., "C:\\Users\\YourName\\Desktop\\ActorLocation.log"
...
Interceptor.attach(CastSpell_VA, {
    onEnter: function(args) {
        /*
         * Arguments:
         * - args[0]: ADH_SpellManager* (this pointer)
         * - args[1]: AActor* Source (actor casting the spell)
        ...
        if (!SourceActor_ptr.isNull()) {
            ...
            const logMessage = `[CastSpell] SourceActor: ${SourceActor_ptr}, SpellClass: ${SpellClass_ptr}, TargetActor: ${TargetActor_ptr}, Tier: ${Tier}`;
            writeLog(logMessage);
        }
    },
...
Interceptor.attach(execK2_GetActorLocation_VA, {
    ...
    onLeave: function(retval) {
        ...
        try {
            ...
            // Optional: If you want to track actors for spell casting as well, you can integrate additional logic here.
