...
var UClass_GetPrivateStaticClass = new NativeFunction(base.add(0x2AEE770), 'pointer', [], 'win64');
...
function getClass(ClassName) {
    ...
    if (!Clazz.isNull()) {
		logInfo("Successfully loaded static mesh");
        return Clazz;
    }
...
var ActorGroups = {
	...
	*/
	"Group10": [
		 //['/Game/LookoutTower/SM_Lookout_Tower_Lod1.SM_Lookout_Tower_Lod1', [0, 0, 0], [-31886.56, 139.76, 50.18], [1, 1, 1]],
		 //with chain
		 ['/Game/Environment/Props/Explorers/LookoutTower/SM_Lookout_Tower2.SM_Lookout_Tower2', [0, 0, 0], [-29971.38, 213.38, 50.18], [1, 1, 1]],
		 //sit
